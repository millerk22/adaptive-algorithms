...
if __name__ == "__main__":
    parser = ArgumentParser(description="Run adaptive search/sampling experiments.")
    parser.add_argument("--dataset", default="test", help="Name of dataset, referenced in load_dataset")
